...
router.get('/wechartlogincallback', sign.wechartlogincallback);
router.post('/thirdloginsubmitinfo', sign.thirdloginsubmitinfo);
...
router.get('/api/work/getworkcomments', works.getworkcomments_api);
